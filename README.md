...
Avec le parcours fait et les connaissances acquises dans cette formation (déjà détenteur des badges "connaissance",  "cursus" et "maîtrise") j'ai décidé d'être un blogeur.**Je suis donc prêt à intégrer un groupe dans le cadre du projet de création d'application web innovante** dans le domaine des médias.

Je vous convie à suivre mes travaux de la formation sur mes Gists sur https://gist.github.com/dacquin2003  et les esquisses du blog sur http://dacquin2003.neowordpress.fr/.
